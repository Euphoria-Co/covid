  ...
  render() {
    ...
    return (
      <View /*style={{ flex: 1,alignItems: "center" }}*/>
        ...
        <Block flex={false} row center space="between" middle padding={[theme.sizes.base / 0.8, 28]} /*style={styles.header}*/>
          <Text h2 light center>Czy podejrzewasz że jesteś zarażony?</Text>
          </Block>
